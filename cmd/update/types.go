...
const (
	...
	defaultSource = "portal_transparencia"
)

type RecordMetadata struct {
	Source    string `json:"source"`     // Source identifier (e.g., "tesouro_transparente")
	UpdatedAt string `json:"updated_at"` // ISO 8601 timestamp when this record was last updated
}
